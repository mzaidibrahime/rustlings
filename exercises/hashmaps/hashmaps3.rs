...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        //     let updated_team_2_score = scores.entry(team_2_name).or_insert(team_goal_details);
        //     updated_team_2_score.goals_scored += team_2_score;
        //     updated_team_2_score.goals_conceded += team_1_score;
        // } else {
        //     let updated_team_2_score = scores.entry(team_2_name).or_insert(team_goal_details);
        // }
